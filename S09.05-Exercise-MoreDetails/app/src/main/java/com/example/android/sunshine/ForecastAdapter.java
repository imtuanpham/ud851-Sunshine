...
//      COMPLETED (36) Refactor onClick to accept a long as its parameter rather than a String
        void onClick(long weatherDateMs);
    }
...
//            String weatherForDay = weatherSummary.getText().toString();
            ...
            long dateMs = mCursor.getLong(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE));
            mClickHandler.onClick(dateMs);
        }
    }
}