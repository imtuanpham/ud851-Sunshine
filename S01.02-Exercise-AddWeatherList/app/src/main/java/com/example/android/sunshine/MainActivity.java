...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherTextView = (TextView) this.findViewById(R.id.tv_weather_data);

        // COMPLETED (3) Create an array of Strings that contain fake weather data
        String[] weatherData = {"Portland 50F", "New York 20F", "Saigon 90F"};

        // COMPLETED (4) Append each String from the fake weather data array to the TextView
        for (String location:weatherData) {
            weatherTextView.append(location + "\n\n");
        }
    }
}