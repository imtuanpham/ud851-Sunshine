...
//  COMPLETED (17) Create constant int values representing each column name's position above
    private final int IDX_COLUMN_DATE = 0;
    private final int IDX_COLUMN_DEGREES = 1;
    private final int IDX_COLUMN_MIN_TEMP = 2;
    private final int IDX_COLUMN_MAX_TEMP = 3;
...
//          COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        return new AsyncTaskLoader<Cursor>(this) {
            ...
            public Cursor loadInBackground() {
                ...
                try {
                    return getContentResolver().query(WeatherContract.WeatherEntry.CONTENT_URI,
                            null,
                            null,
                            null,
                            WeatherContract.WeatherEntry.COLUMN_DATE);
