...
//        forecastAdapterViewHolder.weatherSummary.setText(weatherForThisDay);
        ...
        int idxDate = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE);
        int idxWeatherId = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID);
        int idxHigh = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP);
        int idxLow = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP);

         /* Get human readable string using our utility method */
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext,
                mCursor.getLong(idxDate), false);

        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext,
                mCursor.getInt(idxWeatherId));

        String weatherSummary = dateString
                + "|" + description
                + "|" + mCursor.getString(idxHigh)
                + "|" + mCursor.getString(idxLow);
