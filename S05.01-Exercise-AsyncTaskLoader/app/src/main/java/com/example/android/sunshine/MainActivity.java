...
public class MainActivity extends AppCompatActivity
    ...
    private static final String WEATHER_LOCATION_EXTRA = "weather_location";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_DATA_LOADER, null, this);
...
//        new FetchWeatherTask().execute(location);
        ...
        queryBundle.putString(WEATHER_LOCATION_EXTRA, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String> weatherDataLoader = loaderManager.getLoader(WEATHER_DATA_LOADER);
        if (weatherDataLoader == null) {
            loaderManager.initLoader(WEATHER_DATA_LOADER, queryBundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_DATA_LOADER, queryBundle, this);
        }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        ...
        class FetchWeatherAsyncTaskLoader extends AsyncTaskLoader<String[]> {

            private String[] cachedWeatherData;

            public FetchWeatherAsyncTaskLoader(Context context) {
                super(context);
            }
            ...
            public String[] loadInBackground() {
                ...
                String location = args.getString(WEATHER_LOCATION_EXTRA);
        ...
        return new FetchWeatherAsyncTaskLoader(this);
    }
